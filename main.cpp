...
public:
  ...
  void ParseCommandLine(int argc, char **argv) {
    static const char *help = "NeoBytes-seeder\n"
...
static const string mainnet_seeds[] = {"dnsseed.neobytes.tools", ""};
static const string testnet_seeds[] = {"testnet-seed.neobytes.tools", ""};
static const string *seeds = mainnet_seeds;

extern "C" void* ThreadSeeder(void*) {
  if (fTestNet) {
    db.Add(CService("193.107.20.37", 12427), true);
  } else {
    db.Add(CService("193.107.20.37", 11427), true);
  }
  do {
